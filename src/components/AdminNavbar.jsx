...
export default function AdminNavbar() {
  ...
  const navLinks = [
    ...
    { label: "Blogs Manager", href: "/admin/blogs", icon: BookOpen },
  ];

  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-slate-200/50 h-16 w-full flex items-center justify-between px-6 sm:px-10 shadow-sm">
      ...
      <Link href="/admin/dashboard" className="flex items-center gap-3 group">
        ...
        <div className="flex items-baseline gap-0.5 text-slate-900">
          ...
          <span className="text-sm font-black font-outfit text-purple-600">.</span>
        </div>
      </Link>
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-slate-900 text-white hover:bg-purple-600 transition-colors text-xs font-bold uppercase tracking-wider cursor-pointer shadow-sm"
        >
