...
//                 </div>
//                 <div className="space-y-1.5">
//                   <label className="text-[10px] font-black uppercase text-slate-550 tracking-wider">Badge Tags (Comma-separated)</label>
//                   <input
//                     type="text"
//                     value={throwableTags}
...
//                 </div>
//                 <div className="space-y-1.5">
//                   <label className="text-[10px] font-black uppercase text-slate-550 tracking-wider">Sub-description</label>
//                   <textarea
//                     rows={3}
...
//               <div className="grid grid-cols-1 gap-4">
//                 <div className="space-y-1.5">
//                   <label className="text-[10px] font-black uppercase text-slate-550 tracking-wider">Workflow Section Title</label>
...
//                 </div>
//                 <div className="space-y-1.5">
//                   <label className="text-[10px] font-black uppercase text-slate-550 tracking-wider">Workflow Section Subtitle</label>
...
//                 </div>
//                 <div className="space-y-1.5">
//                   <label className="text-[10px] font-black uppercase text-slate-550 tracking-wider">Workflow Section Description</label>
