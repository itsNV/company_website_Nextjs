      ...
      <main className="flex-grow pt-28 pb-16 bg-transparent relative z-10 reveal-container">
        ...
        <section id="about" className="py-16 bg-white/40 border-y border-[#eae6fa]/20">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="reveal-item text-3xl font-extrabold font-outfit text-slate-900 mb-6">Key Focus Areas</h2>
            ...
            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-200/50">
              ...
              <ul className="reveal-stagger grid grid-cols-1 sm:grid-cols-2 gap-4">
                {solutions.map((item, idx) => (
                  <li key={idx} className="hover-box p-4 rounded-xl bg-white border border-slate-100 text-slate-700 text-xs font-bold shadow-sm">
                    {item}
                  </li>
                ))}
              </ul>
        ...
        <section id="services" className="py-20">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="reveal-item text-3xl md:text-4xl font-extrabold font-outfit text-slate-900 text-center mb-4">What You Get</h2>
            <p className="reveal-item text-slate-500 text-center max-w-xl mx-auto mb-16">High-performance deliverables packed with modern technologies for optimal speed and search indexing.</p>
        ...
        <section id="works" className="py-20 bg-slate-50/50 border-t border-slate-200/40">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <p className="reveal-item text-slate-500 text-center max-w-xl mx-auto mb-16">A roadmap from project definition to production deployment and long-term search visibility.</p>
            
            <div className="reveal-stagger grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {process.map((step, idx) => (
                <div key={idx} className="hover-box relative p-8 rounded-3xl border border-slate-100 bg-white shadow-sm flex flex-col justify-between group">
                  <div>
