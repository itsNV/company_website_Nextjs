      ...
      <main className="flex-grow pt-28 pb-16 bg-transparent relative z-10 reveal-container">
        ...
        <section id="about" className="py-16 bg-white/40 border-y border-[#eae6fa]/20">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="reveal-item text-3xl font-extrabold font-outfit text-slate-900 text-center mb-12">Marketing Capabilities</h2>
        ...
        <section id="services" className="py-20">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <p className="reveal-item text-slate-500 text-center max-w-xl mx-auto mb-16">Data-driven strategies backed by multi-platform marketing reach and performance tracking.</p>
        ...
        <section id="works" className="py-20 bg-slate-50/50 border-t border-slate-200/40">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="reveal-item text-3xl font-extrabold font-outfit text-slate-900 text-center mb-4">Our Marketing Process</h2>
            <p className="reveal-item text-slate-500 text-center max-w-xl mx-auto mb-16">A roadmap from digital performance audit and keyword setup to campaign launch and ROI optimization.</p>
