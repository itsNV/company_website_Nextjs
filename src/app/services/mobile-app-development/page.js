      ...
      <main className="flex-grow pt-28 pb-16 bg-transparent relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-6 text-center lg:text-left grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-8 flex flex-col items-center lg:items-start">
              ...
              <div className="mt-8 flex flex-wrap gap-4 justify-center lg:justify-start">
                <a
                  href="/contact"
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-indigo-600 text-white font-bold hover:bg-slate-900 transition-all duration-300 shadow-lg shadow-indigo-100"
                >
        ...
        <section className="py-16 bg-white/40 border-y border-[#eae6fa]/20">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-3xl font-extrabold font-outfit text-slate-900 text-center mb-12">Services We Offer</h2>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-extrabold font-outfit text-slate-900 text-center mb-4">Key Scope & Features</h2>
            <p className="text-slate-500 text-center max-w-xl mx-auto mb-16">Features engineered uniquely for your application ecosystem to provide top-notch touch responsiveness and performance.</p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feat, idx) => {
                const Icon = feat.icon;
                return (
                  <div key={idx} className="group p-8 rounded-3xl border border-slate-200/60 bg-white/70 backdrop-blur-sm shadow-sm hover:shadow-lg hover:shadow-indigo-50 hover:-translate-y-1 transition-all duration-300">
        ...
        <section className="py-20 bg-slate-50/50 border-t border-slate-200/40">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <p className="text-slate-500 text-center max-w-xl mx-auto mb-16">A systematic development process that turns your application concept into a successful app-store product.</p>
