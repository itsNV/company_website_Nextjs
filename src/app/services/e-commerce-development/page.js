      ...
      <main className="flex-grow pt-28 pb-16 bg-transparent relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-6 text-center lg:text-left grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-8 flex flex-col items-center lg:items-start">
              ...
              <div className="mt-8 flex flex-wrap gap-4 justify-center lg:justify-start">
                <a
                  href="/contact"
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-rose-600 text-white font-bold hover:bg-slate-900 transition-all duration-300 shadow-lg shadow-rose-100"
                >
        ...
        <section className="py-16 bg-white/40 border-y border-[#eae6fa]/20">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-3xl font-extrabold font-outfit text-slate-900 text-center mb-12">Commerce Capabilities</h2>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <p className="text-slate-500 text-center max-w-xl mx-auto mb-16">High performance and optimized checkouts to elevate conversion numbers and sales volume.</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {features.map((feat, idx) => {
                const Icon = feat.icon;
                return (
                  <div key={idx} className="group p-8 rounded-3xl border border-slate-200/60 bg-white/70 backdrop-blur-sm shadow-sm hover:shadow-lg hover:shadow-rose-50 hover:-translate-y-1 transition-all duration-300">
        ...
        <section className="py-20 bg-slate-50/50 border-t border-slate-200/40">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-3xl font-extrabold font-outfit text-slate-900 text-center mb-4">Our E-commerce Store Journey</h2>
            <p className="text-slate-500 text-center max-w-xl mx-auto mb-16">We plan, integrate, and launch high-converting storefronts through a step-by-step methodology.</p>
